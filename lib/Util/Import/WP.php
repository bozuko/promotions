...
class Promotions_Util_Import_WP extends WP_Importer {
	...
	function Promotions_Util_Import_WP() { /* nothing */ }
...
<?php
	...
	function process_posts() {
      ...
      /**
			 * This is added to overwrite existing...
			 */
			$old = get_page_by_path( $post['post_name'], null, $post['post_type'] );
			if( $old ){
	 ...
	 */
	function parse( $file ) {
		$parser = new Promotions_Util_Import_Parser_WXR();
